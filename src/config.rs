...
pub const RENDEZVOUS_SERVERS: &[&str] = &["1.14.122.48"];
pub const RS_PUB_KEY: &str = "hpCIvuoA+UCBHVEMlil1Le6m5vtHxEbJJUEjPO6H3s0=";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "http://1.14.122.48:21114";
    pub const OPTION_KEY: &str = "hpCIvuoA+UCBHVEMlil1Le6m5vtHxEbJJUEjPO6H3s0=";
